...
function whc_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar 2', 'whc' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Add your stuff', 'whc' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
function whc_custom_post_type(){
	...
	register_post_type('welcomes', $welcomeArgs);
	register_post_type('welcomecols', $welcomecolArgs);
	register_post_type('facts', $factArgs);
	register_post_type('testimonials', $testimonialArgs);
	register_post_type('forms', $formArgs);
	register_post_type('maps', $mapArgs);
	register_post_type('subscribes', $subscribeArgs);
